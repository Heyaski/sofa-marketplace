...
export default function PaymentModal({
	...
	return (
		<div className='fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4'>
			<div
				className={`bg-white rounded-t-3xl sm:rounded-3xl ${
					showNewCardForm ? 'max-w-2xl' : 'max-w-lg'
				} w-full p-4 sm:p-6 lg:p-8 relative sm:max-h-[90vh] overflow-y-auto`}
			>
				{/* Header */}
				...
				{/* Title */}
				<h2 className='text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-6 text-left'>
