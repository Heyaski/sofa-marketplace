...
# Максимальный размер файла в памяти перед записью на диск
# Для больших ZIP архивов с множеством 3D моделей увеличиваем до 1GB
# Файлы больше этого размера будут автоматически сохраняться на диск
FILE_UPLOAD_MAX_MEMORY_SIZE = 1024 * 1024 * 1024  # 1 GB

# Максимальный размер данных запроса (включая файлы и ZIP архивы)
# Увеличиваем для больших ZIP архивов с множеством файлов
...
# 3. Проверьте, что файлы действительно загружаются в S3, а не на локальный диск
