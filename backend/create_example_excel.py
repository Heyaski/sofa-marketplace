...
def create_example_excel():
    ...
    column_widths = [25, 15, 12, 25, 25, 15, 15, 50, 15, 15]
    ...
    instructions = [
        ...
        ["• ID 3D моделей - ID через запятую (например: model_001,model_002)"],
        ["• id 3d - ID одной 3D модели (приоритет над 'ID 3D моделей', например: model_001)"],
